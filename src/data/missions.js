...
export const MISSIONS_DATA = [
    ...
    slides: [
      ...
      },
      {
        ...
        drills: [
          ...
          { instruction: "Write an h1 that says: SOS — Phantar Vessel Down", check: (v) => /<h1>\s*sos\s*[—-]\s*phantar vessel down\s*<\/h1>/i.test(v), answer: "<h1>SOS — Phantar Vessel Down</h1>" },
        ],
      },
      {
        id: "p",
        ...
        challenge: {
          ...
          check: (v) => {
            ...
            if (/<p>[^<]*<\/p>/.test(n)) return "The tag is right but check the text — needs to mention: Crash landed, Magnolia Texas, and Atmosphere";
        ...
        drills: [
          ...
          { instruction: "Write a paragraph about Zhan's situation — at least one full sentence, anything you want", check: (v) => /<p>[^<]{20,}<\/p>/i.test(v), answer: "<p>The StarBurner is down. Atmosphere failing. We need rescue immediately.</p>" },
...

  {
    ...
    slides: [
      {
        ...
        challenge: {
          ...
          check: (v) => {
            ...
            if (/href/.test(n) && !/phantar/.test(n)) return "Check your href value — it should be https://phantar.gov";
      ...
      },
      {
        ...
        drills: [
          ...
          { instruction: "Write an image of anything — make up a filename and write a proper descriptive alt text", check: (v) => /<img[^>]*src="[^"]+"[^>]*alt="[^"]{10,}"[^>]*>/i.test(v), answer: '<img src="texas-night.jpg" alt="The Texas countryside at night where the StarBurner crash landed">' },
        ],
      },
      {
        id: "combining",
    ...
    bossChallenge: {
      ...
      instruction: "Build the complete visual evidence section. Write: an h2 that says Visual Evidence — Regulation 4,112 Compliance. Then an img with src='crashsite.jpg' and a detailed alt description. Then a link to https://maps.google.com that says: Crash site coordinates — 30.1658° N 95.4613° W",
      check: (v) => {
        if (!v.trim()) return "Type something";
